...
export const { increment, decrement, incrementByAmount, setTableInfo1, setTableInfo2 } = counterSlice.actions;
...
export const selectTableInfo1 = (state: RootState): ISensorData => state.counter.tableInfo1;
export const selectTableInfo2 = (state: RootState): ISensorData => state.counter.tableInfo2;
